<v-card elevation="2" color="{{ $color ?? 'blue' }} lighten-2" rounded class="pa-4 white--text">
    <v-row>
        ...
        <v-col cols="10" class="text-right">
            ...
            <br>
            <div style="display: black" id="button-container-user-sync">
                <v-btn depressed color="primary" onclick="apiSync()">
                    Sync
                </v-btn>
            </div>
            <div style="display: none" id="loader-container-user-sync">
...
<script>
    function apiSync() {
            ...
            var buttonContainer               = document.getElementById('button-container-user-sync');
            var loaderContainer               = document.getElementById('loader-container-user-sync');
            ...
            (async () => {
                const rawResponse = await fetch('/admin/sync/harvest/users', {
                    method: 'POST',
                    headers: {
